...
export default function FileUpload() {
    ...
    */
    ...
    return (
      <>
        {workbook.length === 0 ? (
          <div className="flex min-h-screen flex-col items-center justify-start p-8 pt-12 mt-20 relative overflow-hidden">
            ...
            <form className="file-upload__upload" onSubmit={(e) => e.preventDefault()}>
              <label htmlFor="input-file-upload" className="bg-gradient-to-br from-[#04619F] to-[#033c5a] text-white py-3 px-6 rounded-md transition-colors mt-4 hover:from-[#033c5a] hover:to-[#02253b] relative z-10 cursor-pointer">
                Choose a File
              </label>
          ...
          <div className="output-container bg-gray-100 min-h-screen flex flex-col items-center justify-start p-8 pt-12 mt-0 relative overflow-hidden">
          <table className="table">
            <thead>
              <tr className="bg-gradient-to-br from-[#04619F] to-[#033c5a] text-white">
                <th className="text-left">Chemical</th>
                <th className="text-left">Analysis Message</th>
              </tr>
            </thead>
            <tbody>
          ...
          <button
            ...
            className="bg-gradient-to-br from-[#04619F] to-[#033c5a] text-white py-3 px-6 rounded-md transition-colors mt-4 hover:from-[#033c5a] hover:to-[#02253b] relative z-10 cursor-pointer"
          >
            Clear
          </button>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="absolute bottom-0 left-0 w-full">
